#!/usr/bin/env bash
cd ..
python main.py --dataset falcor3d --img_size 1024 --num_channels 3 --gpu_num 8 --progressive True --phase train \
--labels_coarse 0,1,2,3,4,5,6 --inp_res 4 --input_layer_type const --D_mode separate \
