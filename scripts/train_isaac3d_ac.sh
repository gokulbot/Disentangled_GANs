...
--labels_fine  --labels_coarse 5,6,7,8,0,1,2,3,4 --inp_res 4 --input_layer_type const --D_mode separate \
--cond_weight 1.0 --cond_type L2 --use_z True --use_noise False --use_instance_norm True --resume_snapshot -1 \
--batch_size_test 4 --iteration 1480 --max_iteration 29600 --labels_keep_rate 1.0 --style_res 1024 --seed 1 \
